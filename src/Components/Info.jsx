  ...
  return (
    ...
    <div className='flex justify-center flex-wrap items-center gap-10  mt-16 '>
      <div className='max-w-[480px] p-4'>
        ...
        <h1 className='sm:text-5xl text-4xl font-bold mb-4'>Who We Are</h1>
        <p className=' sm:leading-relaxed text-gray-400'>XV is a community-focused project led by a highly experienced team of Web3 builders and traders. Our founder A On made his name in the industry moderating for several early crypto projects before the 2021 bull run. <br />
